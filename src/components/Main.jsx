...
import ApexCharts from "../Chart/AreaChart";
          ...
          <div classNameName="container-fluid">
            <div classNameName="row mb-2">
              <div classNameName="col-sm-6">
                <h1 classNameName="m-0">Dashboard</h1>
              </div>
              <div classNameName="col-sm-6">
        ...
        <section classNameName="content">
          <div classNameName="container-fluid">
            ...
            <div classNameName="row">
              <div classNameName="col-lg-3 col-6">
                {/* small box */}
                <div classNameName="small-box bg-info">
                  <div classNameName="inner">
                    <h3>150</h3>
                    <p>New Orders</p>
                  </div>
                  <div classNameName="icon">
                    <i classNameName="ion ion-bag"></i>
                  </div>
                  <a href="#" classNameName="small-box-footer">
                    More info <i classNameName="fas fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
              {/* Add other small boxes as needed */}
            </div>
            {/* /.row */}
